...
android {
    ...
    defaultConfig {
        ...
        extra.set(LibKey.artifactIdKey, Libs.bannerView.artifactId)
        extra.set(LibKey.versionKey, Libs.bannerView.version)
        extra.set(LibKey.descKey, Libs.bannerView.desc)
    }
}
