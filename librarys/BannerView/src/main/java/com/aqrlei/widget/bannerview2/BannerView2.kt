package com.aqrlei.widget.bannerview2
...
import com.aqrlei.widget.R
import com.aqrlei.widget.bannerview.enums.IndicatorGravity
import com.aqrlei.widget.bannerview.enums.IndicatorPosition
import com.aqrlei.widget.bannerview.enums.TransformerStyle
import com.aqrlei.widget.bannerview.indicator.IIndicator
import com.aqrlei.widget.bannerview.indicator.IndicatorView
import com.aqrlei.widget.bannerview.utils.BannerUtils
import com.aqrlei.widget.bannerview2.manager.BannerManager
import com.aqrlei.widget.bannerview2.transform.factory.BannerPageTransformerFactory
...
class BannerView2 @JvmOverloads constructor(
    ...
    class Adapter<VH : ViewHolder>(val viewHolder: VH) : ViewPager2.OnPageChangeCallback() {
         ...
         * 可循环时的初始位置
         */
        private fun loopOriginIndex() = LOOP_ORIGIN_INDEX
