package com.aqrlei.widget.bannerview
...
import com.aqrlei.widget.bannerview.manager.BannerManager
import com.aqrlei.widget.bannerview.options.DEFAULT_SCROLL_DURATION
...
class BannerView @JvmOverloads constructor(
    ...
    class BannerViewPager(context: Context) : ViewPager(context) {
        ...
        private fun hookScroller() {
            try {
                bannerScroller = BannerScroller(context).also {
